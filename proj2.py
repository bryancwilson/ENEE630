...
# ----------------------------------- MSE Filterbank -----------------------------------
# calculate_MSE(1, snr=0, H0=H0, H1=H1, F0_1=F0_1, F1_1=F1_1)
# calculate_MSE(2, snr=0, H0=H0, H1=H1, F0_1=F0_1, F1_1=F1_1)
# calculate_MSE(1, snr=0, H0=H0, H1=H1, F0_1=F0_2, F1_1=F1_2)
# calculate_MSE(2, snr=0, H0=H0, H1=H1, F0_1=F0_2, F1_1=F1_2)
...
# mse_option2_input2 = []
# for snr in range(21):
#     mse_option1_input1.append(calculate_MSE(1, snr=snr, H0=H0, H1=H1, F0_1=F0_1, F1_1=F1_1))
#     mse_option1_input2.append(calculate_MSE(2, snr=snr, H0=H0, H1=H1, F0_1=F0_1, F1_1=F1_1))
#     mse_option2_input1.append(calculate_MSE(1, snr=snr, H0=H0, H1=H1, F0_1=F0_2, F1_1=F1_2))
#     mse_option2_input2.append(calculate_MSE(2, snr=snr, H0=H0, H1=H1, F0_1=F0_2, F1_1=F1_2))
...
# plt.show()
# # -------------------------------------- Apply Scrambling ----------------------------------------
generate_pn_sequence(pn_type=1, vector_size=1024)
